...
CREATE INDEX "idx_birdeye_tokens_activity_score" ON "birdeye_tokens" USING btree ("activity_score");--> statement-breakpoint
CREATE INDEX "idx_birdeye_tokens_opportunity_score" ON "birdeye_tokens" USING btree ("opportunity_score");--> statement-breakpoint
...
CREATE INDEX "idx_opportunity_expires" ON "opportunity_events" USING btree ("expires_at");